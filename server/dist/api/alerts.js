...
module.exports = (app) => {
    ...
    app.get('/v1/me/jobs', verify_1.isAuthenticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const user = req.user;
            const results = yield db_1.default.query('select * from jobs where uid=$1 order by jid desc', [user.uid]);
    ...
    app.post('/v1/jobs', verify_1.isAuthenticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const user = req.user;
            const result = yield db_1.default.query('insert into jobs(website, product, price, uid, created_at, status) values($1, $2, $3, $4, $5, $6)', [req.body.website, req.body.product, req.body.price, user.uid, date, 'active']);
            res.status(200).send(result.rows);
        }
        catch (error) {
            throw error;
